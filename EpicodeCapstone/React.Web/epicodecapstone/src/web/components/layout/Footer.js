                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="single-footer-widget">
                                ...
                                <p>Sasy Shop is a Multi Vendors eCommerce Web Application built with the help of ASP MVC .NET 6 and React Js. The Admin/Vendor Panel is build with ASP MVC .NET 6 and Front End (Customer Store) is built with React Js plus .NET 6 Rest APIs.</p>
                            </div>
                        </div>
                            ...
                            <div className="single-footer-widget">
                                ...
                                <ul className="footer-contact-info">
                                    <li>
                                        ...
                                        </span>  Via Della Libertà 22 <br /> Napoli, Italy
                                    </li>
                                    <li>
                                        ...
                                        </span> <Link to="tel:(+123) 456-7898">(+39) 3913616625</Link>
                                    </li>
                                    <li>
                                        ...
                                        </span> <Link to="mailto:support@novine.com">sasyragosta240@gmail.com</Link>
                                    </li>
                                    <li>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <p>Copyright &copy; 2024 Sasy Shop. All Rights Reserved By <a href="https://www.linkedin.com/in/salvatore-ragosta-09b783281/" target="_blank" rel="noopener noreferrer">Salvatore Ragosta</a></p>
                            </div>
