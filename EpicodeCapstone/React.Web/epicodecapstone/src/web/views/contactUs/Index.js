            ...
            <div className="col-lg-5 col-md-12">
              <div className="contact-info">
                ...
                <ul className="contact-list">
                  <li><i className="fas fa-map-marker-alt"></i><span id="lbl_cont_location">Location:</span>  Via Della Libertà 21, Italy</li>
                  <li><i className="fas fa-phone"></i><span id="lbl_cont_callus">Call Us:</span>  <a href="#">(+39) 3913616625</a></li>
                  <li><i className="far fa-envelope"></i><span id="lbl_cont_email">Email Us:</span>  <a href="#">sasyragosta24@gmail.com</a></li>
