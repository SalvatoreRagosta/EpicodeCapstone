...
export const RedirectToWhatsAppPage = () => {
    window.open('https://wa.me/3913616625', '_blank');
}



export const GetDefaultCurrencySymbol = () => {
    let DefaultCurrencySymbol = "€";  //--EUR is consider as default if there is no setting in appsetting.json file
...
export const GetDefaultCurrencyCode = () => {
    let DefaultCurrencyCode = "EUR";  //--EUR is consider as default if there is no setting in appsetting.json file
